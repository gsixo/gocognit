[![Go Reference](https://pkg.go.dev/badge/github.com/gsixo/gocognit.svg)](https://pkg.go.dev/github.com/gsixo/gocognit)
...
```shell
go install github.com/gsixo/gocognit/cmd/gocognit@latest
```

or 

```shell
go get github.com/gsixo/gocognit/cmd/gocognit
```
